...
export const ACTIVE_TOOLS_LABEL = i18n.translate(
  'xpack.stackConnectors.components.mcp.activeToolsLabel',
  {
    defaultMessage: 'Active MCP tools',
  }
);
...
export const TOOL_COLUMN_LABEL = i18n.translate(
  'xpack.stackConnectors.components.mcp.toolColumnLabel',
  { defaultMessage: 'Tool' }
);

export const ACTIVE_COLUMN_LABEL = i18n.translate(
  'xpack.stackConnectors.components.mcp.activeColumnLabel',
  { defaultMessage: 'Active' }
);

export const CONNECT_TO_SELECT_TOOLS_HELP = i18n.translate(
  'xpack.stackConnectors.components.mcp.connectToSelectToolsHelp',
  { defaultMessage: 'Connect to your MCP server to select tools.' }
);

export const SEARCH_TOOLS_PLACEHOLDER = i18n.translate(
  'xpack.stackConnectors.components.mcp.searchToolsPlaceholder',
